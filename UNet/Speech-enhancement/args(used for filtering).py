...
parser.add_argument('--noise_dir', default='/home/lab2208/UNet/Speech-enhancement/data/train/noise', type=str)

#parser.add_argument('--voice_dir', default='/data/train/clean_voice', type=str)
parser.add_argument('--voice_dir', default='/home/lab2208/UNet/Speech-enhancement/data/train/clean_voice', type=str)
...
parser.add_argument('--path_save_spectrogram', default='/home/lab2208/UNet/Speech-enhancement/data/train/spectrogram/', type=str)


#parser.add_argument('--path_save_time_serie', default='/data/train/time_serie/', type=str)
parser.add_argument('--path_save_time_serie', default='/home/lab2208/UNet/Speech-enhancement/data/train/time_serie/', type=str)



#parser.add_argument('--path_save_sound', default='/data/train/sound/', type=str)
parser.add_argument('--path_save_sound', default='/home/lab2208/UNet/Speech-enhancement/data/train/sound/', type=str)
...
parser.add_argument('--frame_length', default=16000 * 80, type=int)
# hop length for clean voice files separation (no overlap)
parser.add_argument('--hop_length_frame', default=16000 * 80, type=int)
...
parser.add_argument('--hop_length_fft', default=512, type=int)
