...
min_duration, frame_length, hop_length_frame, hop_length_frame_noise, nb_samples, n_fft, hop_length_fft):
    ...
    sf.write(path_save_sound + 'noisy_voice_long.wav', noisy_voice_long[0, :], sample_rate)  # Updated
    ...
    sf.write(path_save_sound + 'voice_long.wav', voice_long[0, :], sample_rate)  # Uncommented and updated
    ...
    sf.write(path_save_sound + 'noise_long.wav', noise_long[0, :], sample_rate)  # Updated
