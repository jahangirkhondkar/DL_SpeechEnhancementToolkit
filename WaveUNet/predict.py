...
if __name__ == '__main__':
    ...
    parser.add_argument('--load_model', type=str, default='checkpoints/waveunet/checkpoint_147220',
...
#    parser.add_argument('--input', type=str, default=os.path.join("Text_dependent_raw_data/collection 6/", "20160104026L2.wav"),
    parser.add_argument('--input', type=str, default=os.path.join("Text_dependent_raw_data/","Collection 13/"),
                        help="Path to input mixture to be separated")
    parser.add_argument('--output', type=str, default='output', help="Output path (same folder as input path if not set)")
